<template>
  <section class="mx-auto max-w-5xl space-y-6">
    ...
    <div v-else class="space-y-6">
      <article class="rounded-4xl border border-slate-200 bg-slate-950 p-8 text-white shadow-[0_20px_60px_-40px_rgba(15,23,42,0.4)]">
      ...
      <div class="grid gap-5 md:grid-cols-2">
        <RouterLink
          ...
          class="block rounded-4xl border border-slate-200 bg-white p-6 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.28)] transition hover:border-emerald-300 hover:shadow-[0_24px_70px_-40px_rgba(16,185,129,0.45)]"
        >
          ...
          <p class="mt-4 text-right text-sm font-semibold text-emerald-600">{{ $t('accounts.viewDetails') }} →</p>
        </RouterLink>
      </div>
    </div>
  </section>
