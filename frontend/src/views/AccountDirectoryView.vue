  ...
  <section class="mx-auto max-w-6xl space-y-6">
    ...
    <div v-else class="space-y-4">
      ...
      <RouterLink
        ...
        class="flex flex-wrap items-center justify-between gap-4 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.28)] transition hover:border-emerald-300 hover:shadow-[0_24px_70px_-40px_rgba(16,185,129,0.45)]"
      >
        <div class="space-y-1">
